...
class StrategyParams:
    ...
    # Which names the ranking list holds: every name that has a score, each carrying whether it may be
    # bought, or only those that pass every entry filter (ADR-033). The universe scope is the live default:
    # a name's place is its momentum, and the qualification only decides whether step 11 may open it.
    rank_scope: Literal["qualified", "universe"] = "universe"
